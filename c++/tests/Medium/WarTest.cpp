...
{
  inputFile = ifstream("./c++/tests/DataFiles/Medium/War/3Cards_in.txt");
  War::main();
...
{
  inputFile = ifstream("./c++/tests/DataFiles/Medium/War/26Cards_in.txt");
  War::main();
...
{
  inputFile = ifstream("./c++/tests/DataFiles/Medium/War/26CardsMediumLength_in.txt");
  War::main();
...
{
  inputFile = ifstream("./c++/tests/DataFiles/Medium/War/Battle_in.txt");
  War::main();
...
{
  inputFile = ifstream("./c++/tests/DataFiles/Medium/War/OneGameOneBattle_in.txt");
  War::main();
...
{
  inputFile = ifstream("./c++/tests/DataFiles/Medium/War/TwoChainedBattles_in.txt");
  War::main();
  EXPECT_STREQ("2 1", outputstream.str().data());
}
...
{
  inputFile = ifstream("./c++/tests/DataFiles/Medium/War/LongGame_in.txt");
  War::main();
...
TEST_F(WarTest, Pat1)
{
  inputFile = ifstream("./c++/tests/DataFiles/Medium/War/Pat1_in.txt");
  War::main();
...
TEST_F(WarTest, Pat2)
{
  inputFile = ifstream("./c++/tests/DataFiles/Medium/War/Pat2_in.txt");
  War::main();
  EXPECT_STREQ("PAT", outputstream.str().data());
}
